...
public:
	...
	*/
	...
	vector<int> get_Matrix_row(int number_row);//Получить строку матрицы, хранящий взвешанный граф.
	vector<int> get_Matrix_column(int number_column);//Получить столбец матрицы, хранящий взвешанный граф.
	...
	//Сеттеры. (Если изменить значения в матрице, хранящий взвешанный граф, то алгоритм Беллмана-Форда нужно будет применить ещё раз для новых данных).
